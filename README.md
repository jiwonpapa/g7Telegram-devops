...
> 공개 베타 `v0.6.1-beta.5`: 실제 서버에 설치할 수 있지만 아직 `1.0` 정식판은 아닙니다.
...
g7telegram-devops_0.6.1-beta.5_amd64.deb: OK
[apt 패키지 설치 로그]
...
Agent health: PASS
Installed g7telegram-devops_0.6.1-beta.5_amd64.deb
```
